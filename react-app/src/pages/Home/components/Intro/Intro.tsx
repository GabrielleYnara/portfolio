import puzzle from "../../../../assets/img/puzzle-pieces.svg";
import sparkle2 from "../../../../assets/img/sparkle2.svg";
...
function Intro(){
    return <section className="intro">
        <div className="starry-field">
            <div className="inner-content">
                <img src={puzzle} id="intro-puzzle" aria-hidden />
                ...
                <img src={sparkle2} id="intro-sparkle" aria-hidden />                
            </div>
        </div>
    </section>;
}
